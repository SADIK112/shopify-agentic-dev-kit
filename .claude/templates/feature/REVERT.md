...
A git revert only undoes code. It does NOT undo database migrations, deployed
Shopify Functions, registered webhooks, or created metafield definitions.
...
Common delete mutations for reference:
- Discount: `discountAutomaticDelete` / `discountCodeDelete`
- Webhook: `webhookSubscriptionDelete`
- Metafield definition: `metafieldDefinitionDelete`
- Function: redeploy app with extension removed (`shopify app deploy`)
